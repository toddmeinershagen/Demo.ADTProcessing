...
namespace Demo.ADTProcessing.Router.RabbitMQ
{
    public class RabbitMqEndpointAddress
    {
        ...
        public RabbitMqEndpointAddress ForQueue(string name)
        {
        ...
        public RabbitMqEndpointAddress ForQueue(Uri originalUri, string name)
        {
        ...
        public static RabbitMqEndpointAddress Parse(Uri address)
        {
            ...
            if (address.UserInfo != string.Empty)
            {
